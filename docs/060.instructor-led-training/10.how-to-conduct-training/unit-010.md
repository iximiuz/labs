...
it's possible to see the training's landing page but not its program and the linked materials). See [How to Restrict Training Materials to Your Students](/docs/instructor-led-training/training-access-control) for more details.
