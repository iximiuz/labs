---
title: What are iximiuz Labs Courses
...
Where a [Tutorial](/docs/learning-materials/tutorials) covers one focused topic and a [Challenge](/docs/learning-materials/challenges) hands you one hands-on problem to solve, **a Course ties many of tutorial-like lessons and complementary challenges together into an ordered curriculum**.
You move through it lesson by lesson, reading the material, running commands in a Playground, and solving Challenges to prove you've understood each part before continuing.
...
Completed Lessons and solved Challenges are recorded as you go, so you can always see how far you are and pick up exactly where you left off. The overall status of a Course - started and completed - is reflected in your [personal dashboard](/dashboard).
...
:kind: warning
---
As with [Challenges](/docs/learning-materials/challenges) and [Tutorials](/docs/learning-materials/tutorials), handing the Challenges to an autonomous coding agent will technically mark them complete, but the learning happens in the doing.
::
...
If a Course feels too advanced, study the prerequisites first - browse related [Tutorials](/docs/learning-materials/tutorials) or warm up with a few [easy Challenges](/challenges?difficulty=easy) on the same topic.
...
[**Tutorials**](/docs/learning-materials/tutorials) are long-form, guided articles that explain a topic and let you follow along in a Playground.
...
If you prefer to assemble your own path, [Skill Paths](/docs/learning-materials/skill-paths) offer looser, more flexible ways to combine the same materials.

## Where to start

[Browse the catalog](/courses) and pick a Course that matches your interests and current level.
